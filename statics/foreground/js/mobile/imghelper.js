...
function filechange(files, imgid, filekey, url, callback, errorCallback) {
    ...
    for (var i = 0, f; f = files[i]; i++) {
        ...
        reader.onload = function (e) {
            ...
            img.onload = function () {
                ...
                uploadimg(data, filename, filetype, filekey, url, callback, errorCallback);
            }
        };
...
function uploadimg(data, filename, filetype, filekey, url, callback, errorCallback) {
