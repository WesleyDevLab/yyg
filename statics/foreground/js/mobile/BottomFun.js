...
var addNumToCartFun = null; (function() {
   // Gobal.Skin = "http://mskin.1ytb.cc";
    ...
    function(h) {       
        var g = '<span><a href="'+Gobal.Webpath+'">首页</a><b></b></span><span><a href='+Gobal.Webpath+'/mobile/mobile/about>新手指南</a><b></b></span>';
        if (h.code == 0) {		   
            g = g + '<span><a href="'+Gobal.Webpath+'/home" class="Member">' + h.username + '</a><a href="'+Gobal.Webpath+'/mobile/user/cook_end" class="Exit">退出</a></span>'
        } else {
            g = g + '<span><a href="'+Gobal.Webpath+'/user/login">登录</a><b></b></span><span><a href="'+Gobal.Webpath+'/mobile/register">注册</a></span>'
        }
