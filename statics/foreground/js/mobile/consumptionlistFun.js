$(function() {
    var a = function() {	 
        ...
        var r = function() {
            ...
            var y = function() {
                d.show();				 
               // GetJPData("http://m.1ytb.cc", "getUserRecharge", w(),
                ...
                function(D) {
                    if (D.code == 0) {
                        ...
                        if (v.isCount == 1) {
                            x = D.count;
                            v.isCount = 0;
                            B = '<li class="m-userMoneylst-tt"><span>充值时间</span><span></span><span>充值元宝</span></li>'
                        }
                        var C = D.listItems;
                        var A = C.length;
                        for (var z = 0; z < A; z++) {
                            B += '<li class="' + (z + 1 == A ? "bornone": "") + '"><span>' + C[z].time + "</span><span></span><span>" + C[z].money + "</span></li>"
                        }
                        if (v.FIdx > 0) {
                ...
                function(D) {
                    if (D.code == 0) {
                        ...
                        if (v.isCount == 1) {
                            v.isCount = 0;
                            x = D.count;							 
                            B = '<li class="m-userMoneylst-tt"><span>消费时间</span><span>消费元宝</span></li>'
                        }
                        var C = D.listItems;
                        var A = C.length;
                        for (var z = 0; z < A; z++) {
