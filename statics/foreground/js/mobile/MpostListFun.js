$(function() {
    var a = function() {
        ...
        var b = function() {
            ...
            var w = function() {
                e.show();
                //GetJPData("http://m.1ytb.cc", "getUserPostList", u(),
                        ...
                        for (var y = 0; y < B; y++) {
                            ...
                            if (z == 0) {
                                ...
                                if (z == -1) {
                                    ...
                                    if (z == 1) {
                                        A += '<p><span class="green">审核通过，奖励'+C[y].sd_checkFufen+'元宝</span></p>'
                                    }
                                }
                            }
