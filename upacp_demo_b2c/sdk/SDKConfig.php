...
// 签名证书路径
const SDK_SIGN_CERT_PATH = '/data/wwwroot/newyyg/upacp_demo_b2c/certs/502.pfx';

// 签名证书密码
const SDK_SIGN_CERT_PWD = '617637';			//000000

// 密码加密证书（这条一般用不到的请随便配）
const SDK_ENCRYPT_CERT_PATH = '/data/wwwroot/newyyg/upacp_demo_b2c/certs/acp_test_enc.cer';

// 验签证书路径（请配到文件夹，不要配到具体文件）
const SDK_VERIFY_CERT_DIR = '/data/wwwroot/newyyg/upacp_demo_b2c/certs/';
...
// 前台通知地址 (商户自行配置通知地址)
const SDK_FRONT_NOTIFY_URL = 'http://www.91czs.cn/service/front';

// 后台通知地址 (商户自行配置通知地址，需配置外网能访问的地址)
const SDK_BACK_NOTIFY_URL = 'http://www.91czs.cn/service/back';

//文件下载目录 
const SDK_FILE_DOWN_PATH = '/data/wwwroot/newyyg/upacp_demo_b2c/file/';

//日志 目录 
const SDK_LOG_FILE_PATH = '/data/wwwroot/newyyg/upacp_demo_b2c/logs/';
