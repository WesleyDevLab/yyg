...
<div class="header lr10">
	<h3 class="nav_icon">充值记录</h3>
	<span class="span_fenge lr10"></span>
	<a href="/admin/member/recharge/cz">充值记录</a>
	<span class="span_fenge lr5">|</span>
	<a href="/admin/member/recharge/xf">消费记录</a>
</div>
<div class="bk10"></div>
  ...
  <table width="100%" cellspacing="0">
    ...
    <tbody>
		...
		<tr>
			...
			<td align="center"><?php echo $recharge[$j]['content']=='充值'?'通过银联充值':$recharge[$j]['content']; ?></td>	
