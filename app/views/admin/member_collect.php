...
<div class="table-list lr10" >
  <div class="header-data lr10" style="margin-bottom:20px;margin-top:20px;">
       ...
       商品类型：<select id="good_type">
       		<option value="">全部</option>
       		<option value="1">限时抢购</option>
       		<option value="2">满员开奖</option>
       		<option value="3">心愿商品</option>
       </select>&nbsp;&nbsp;
       商品名称：<input id="good_name" value="<?php echo isset($good_name) ? $good_name : '';?>" type="text" class="input-text">&nbsp;&nbsp;
      收藏日期: <input name="posttime1" value="<?php echo isset($posttime1) ? $posttime1 : '';?>" type="text" id="posttime1" class="input-text posttime" readonly="readonly">-
    ...
    <tbody>
          ...
          ?>
              ...
              <td align='center'>
				...
				echo $arr[$row['good_type']];	
              	?>
              </td>
              <td align='center'><?php echo $row['good_name']?></td>
          	  <td align='center'><?php echo $row['collect_date']?></td>
...
$(function(){
	$('.jq_button').click(function(){
		...
		window.location.href="<?php echo G_WEB_PATH;?>/admin/membercount/collect"+where;
	})
})
