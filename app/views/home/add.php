...
<div class="n-h-tit"><h1 class="header-logo">添加收货地址</h1></div>
</div>
</header>
...
.registerCon .form{
 ...
 <section>
	   ...
	   <form class="registerform" method="post" action="<?php echo G_WEB_PATH;?>/home/useraddress" onsubmit="return check_form();">
	...
	<!--
		<div class="registerCon">
    	        ...
    	        <ul style="display: block;" class="form">
                    ...
                    <li>
					<input id="default" name="default" placeholder="" value="Y" type="hidden">
	...
	<br/>	<br/>
        ...
        <div class="aui-form">
        	<div class="aui-input-row">
                ...
                <input name="shouhuoren" id="shouhuoren" type="text" class="aui-input" placeholder="填写收货人姓名"/>
            </div>
			<div class="aui-input-row">
                <span class="aui-input-addon">手机号</span>
                <input name="mobile" id="mobile" type="text" class="aui-input" placeholder="填写收货人手机号码"/>
            </div>
            <div class="aui-input-row">
            ...
            <div class="aui-input-row">
                ...
                <input name="jiedao" id="jiedao" type="text" class="aui-input" placeholder="填写详细地址"/>
            </div>
            <!--<div class="aui-input-row">
            ...
            <div class="aui-input-row">
                ...
                <section id="radio_frame_roby">
					<input id="radio_1" class="radio" value="Y" name="radio" type="radio">
        ...
        <input name="default" id="default" placeholder="" value="Y" type="hidden">
